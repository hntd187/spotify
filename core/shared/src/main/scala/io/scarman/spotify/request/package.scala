...
type Backend      = sttp.client3.SttpBackend[Future, Any]
...
implicit val pupd: Decoder[r.PrivateUser]     = deriveDecoder
implicit val ecd: Decoder[r.ExplicitContent]  = deriveDecoder
implicit val cpd: Decoder[r.CurrentlyPlaying] = deriveDecoder
implicit val ctxd: Decoder[r.Context]         = deriveDecoder
